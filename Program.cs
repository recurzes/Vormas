...
namespace Vormas
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(new Form1(userManager, authService, sessionService, vehicleService, customerService, rateConfigurationService, damageClaimsService, rentalService));
        }
    }
}
